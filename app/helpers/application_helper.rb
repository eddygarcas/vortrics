module ApplicationHelper
  ...
  def trend value = 0, target = 0, icon = :chevon
    class_options = {
  ...
  def work_time_content key, title = '', text = 'n/d'
	  content_tag(:i, nil, class: "fa fa-trophy", style: "color:goldenrod;font-size: 14px;") << title << " shortest " << " <strong>".html_safe << key << "</strong> ".html_safe << text
  end
